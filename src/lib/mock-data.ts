...
export const MOCK_JOBS = [
  ...
  { id: '123', title: '业务支持', department: '职能部', location: '泰国', keywords: '业务支持', 
    details: {
      ...
      gender: '不限（女生优先）',
      age: '不限',
      nationality: '马来 / 越南 / 台湾 / 中国籍女生',
      languages: '中文流利',
      requirements: [
        '工作细心，具有服务意识，工作主动积极；',
        '有客服相关经验或相关服务经验者优先考虑；',
        '熟悉办公室软件并能熟练操作；',
        '沟通能力和理解能力佳，亲和力强，反应快，有耐心，能独立解决问题；',
        '需有招聘助理对接经验及数据表格汇总分析经验；'
      ],
      responsibilities: [
        '工作细心，具有服务意识，主动积极完成任务；',
        '负责对接招聘助理，协助相关事务处理；',
        '熟悉并使用办公软件，进行数据表格汇总与分析；',
        '处理日常客服或支持类工作，具备耐心与良好沟通能力；',
        '独立解决日常问题，确保支持工作顺利开展。'
      ]
    } 
  },
  ...
  { id: '172', title: '渗透学徒', department: '市场部', location: '泰国', keywords: '渗透, 学徒', details: {
      salary: '10K-12K',
      hours: '10-12小时',
      gender: '男',
      age: '21-30岁',
