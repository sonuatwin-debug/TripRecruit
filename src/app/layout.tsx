    ...
    <html lang="zh" className="dark">
      ...
      <body className="font-body antialiased flex flex-col min-h-screen">
        ...
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col space-y-4">
            <a href="https://t.me/XCJT02" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-[#0088cc] text-white hover:bg-opacity-80 transition-colors animate-pulse-glow">
                <Send className="h-6 w-6" />
            </a>
            <a href="https://im.qq.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/80 transition-colors animate-pulse-glow text-2xl" style={{backgroundColor: '#000000'}}>
            ...
            <WechatQrCode>
              <div className="inline-flex items-center justify-center p-3 rounded-full text-white hover:bg-opacity-80 transition-colors animate-pulse-glow text-2xl cursor-pointer" style={{backgroundColor: '#07C160'}}>
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 100 100" fill="currentColor">
                    ...
                    <circle cx="34.95" cy="42.868" r="4.306" fill="#FFF"/>
                    <circle cx="53.07" cy="42.868" r="4.306" fill="#FFF"/>
                  </svg>
              </div>
            </WechatQrCode>
