    ...
    <html lang="zh" className="dark">
      ...
      <body className="font-body antialiased flex flex-col min-h-screen">
        ...
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col space-y-4">
            ...
            <a href="https://im.qq.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center p-3 rounded-full bg-white text-black hover:bg-gray-100 transition-colors animate-pulse-glow text-2xl border">
            ...
            <WechatQrCode>
              <div className="inline-flex items-center justify-center p-3 rounded-full bg-white text-[#07C160] hover:bg-gray-100 transition-colors animate-pulse-glow text-2xl cursor-pointer border">
