    ...
    <div className="flex flex-col">
      ...
      <main className="container py-12 md:py-20 space-y-16">
        <div className="flex gap-4 flex-wrap justify-center -mt-8 mb-12">
            ...
            <a href="mailto:recruitment@trip.com" className="inline-block p-3 rounded-full bg-card text-card-foreground hover:bg-muted transition-colors animate-pulse-glow shadow-lg">
              <Mail className="h-6 w-6" />
            </a>
          </div>
