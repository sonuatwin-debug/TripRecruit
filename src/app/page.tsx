      ...
      <section className="relative h-[60vh] text-white">
        ...
        <div className="relative container h-full flex flex-col justify-center text-center items-center">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-colors">
            ...
            <a href="https://t.me/" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-colors">
              <Send className="h-6 w-6" />
            </a>
            <a href="https://www.wechat.com" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
             ...
             <a href="https://im.qq.com" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a href="https://www.messenger.com" target="_blank" rel="noopener noreferrer" className="inline-block p-3 rounded-full bg-accent text-accent-foreground hover:bg-accent/90 transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" viewBox="0 0 24 24" fill="currentColor">
