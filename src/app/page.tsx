...
const Flag = ({ country }: { country: string }) => {
  const flags: { [key: string]: React.ReactNode } = {
    ...
    柬埔寨: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 600"><path fill="#032ea1" d="M0 0h900v600H0z"/><path fill="#e00025" d="M0 150h900v300H0z"/><path fill="#fff" d="m450 216-90 60v48h180v-48zm-150-12h300v12H300zm-30 132h360v12H270z" stroke="#000" strokeWidth="3"/><path fill="#fff" d="m390 276 30 24v12h-30zm-90 0h30v24h-30zm45 30h30v12h-30zm-30-48h90v12h-90z"/></svg>
    ),
    日本: (
