    ...
    <html lang="zh" className="dark">
      ...
      <body className="font-body antialiased flex flex-col min-h-screen">
        ...
        <div className="fixed right-4 top-1/2 -translate-y-1/2 z-50 flex flex-col space-y-4">
            ...
            <WechatQrCode>
              <div className="inline-flex items-center justify-center p-3 rounded-full bg-primary text-primary-foreground hover:bg-primary/80 transition-colors animate-pulse-glow text-2xl cursor-pointer">
