...
export const contactMethods = [
  ...
  { 
    name: 'LinkedIn', 
    icon: <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M19 3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14zm-11 6H5v9h3V9zM6.5 6.25a1.75 1.75 0 1 0 0-3.5 1.75 1.75 0 0 0 0 3.5zM18 9h-2.5a2.5 2.5 0 0 0-2.5 2.5V18h-3V9h3v1.625A3.5 3.5 0 0 1 15.5 8.5c1.93 0 3.5 1.57 3.5 3.5V18h-3v-5.5a.5.5 0 0 0-.5-.5.5.5 0 0 0-.5.5V18h-3v-5.5a2.5 2.5 0 0 1 2.5-2.5H18V9z" fill="#0A66C2"/></svg>, 
