...
export const MOCK_JOBS = [
  ...
  { 
    ...
    keywords: '财务, 主管',
    details: {
      salary: '2500 - 3500 USD/月',
      hours: '9小时，周休1',
      gender: '不限',
      age: '21-35岁（经验丰富者可适当放宽）',
      nationality: '外籍（马来/印尼优先）/ 台湾籍',
      languages: '中文熟练，英语可基本沟通',
      requirements: [
        '独立负责财务工作小组，能根据公司制度对下属提供支持并监督日常财务工作；',
        '具备较强的成本管理、风险控制和财务数据分析能力，对数据敏感，发现问题及时上报；',
        '能执行并协调财务审核工作；',
        '熟悉预算管理，能统计、汇总月度预算并上报审批；',
        '熟练编制财务分析报表；',
        '具备良好的组织协调能力、表达能力及团队合作精神；',
        '有财务管理岗位经历。'
      ],
      responsibilities: []
    }
  ...
  { 
    ...
    details: {
      ...
      requirements: [],
      responsibilities: [
        '负责公司全部日常账务处理及审查，编制各类管理报表；',
        '对数字敏感，具备数据分析能力，能发现并解决财务问题；',
        '负责应收账款与应付账款的管理与核算；',
